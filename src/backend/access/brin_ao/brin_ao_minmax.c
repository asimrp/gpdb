/*
 * brin_ao_minmax.c
 *		Implementation of Min/Max opclass for BRIN_AO
 *
 * Portions Copyright (c) 1996-2019, PostgreSQL Global Development Group
 * Portions Copyright (c) 1994, Regents of the University of California
 *
 * IDENTIFICATION
 *	  src/backend/access/brin_ao/brin_ao_minmax.c
 */
#include "postgres.h"
...
static FmgrInfo *minmax_get_strategy_procinfo(Brin_AoDesc *bdesc, uint16 attno,
											  Oid subtype, uint16 strategynum);


Datum
brin_ao_minmax_opcinfo(PG_FUNCTION_ARGS)
{
	...
	result = palloc0(MAXALIGN(SizeofBrin_AoOpcInfo(2)) +
					 sizeof(MinmaxOpaque));
	result->oi_nstored = 2;
	result->oi_opaque = (MinmaxOpaque *)
		MAXALIGN((char *) result + SizeofBrin_AoOpcInfo(2));
 ...
 */
Datum
brin_ao_minmax_add_value(PG_FUNCTION_ARGS)
{
 ...
 */
Datum
brin_ao_minmax_consistent(PG_FUNCTION_ARGS)
{
	Brin_AoDesc   *bdesc = (Brin_AoDesc *) PG_GETARG_POINTER(0);
	Brin_AoValues *column = (Brin_AoValues *) PG_GETARG_POINTER(1);
 ...
 */
Datum
brin_ao_minmax_union(PG_FUNCTION_ARGS)
{
	Brin_AoDesc   *bdesc = (Brin_AoDesc *) PG_GETARG_POINTER(0);
 ...
 */
static FmgrInfo *
minmax_get_strategy_procinfo(Brin_AoDesc *bdesc, uint16 attno, Oid subtype,
							 uint16 strategynum)
{
	MinmaxOpaque *opaque;
